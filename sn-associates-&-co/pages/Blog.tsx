        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 pb-20">
            ...
            {selectedPost && (
                <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
                    <div className="bg-white rounded-3xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl relative border border-slate-200 overflow-hidden">
                        {/* Modal Header */}
                        <div className="p-6 border-b border-slate-100 flex items-start justify-between gap-4 bg-slate-50/50">
                            ...
                            <button
                                ...
                                className="text-slate-400 hover:text-slate-700 bg-white hover:bg-slate-100 border border-slate-200 p-2 rounded-full transition shrink-0"
                            >
                                <X size={18} />
                            </button>
                        </div>
                        ...
                        <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                            <span>Published under SN Associates Knowledge Initiative</span>
                            <button
                                onClick={() => setSelectedPost(null)}
                                className="font-semibold text-slate-700 hover:text-slate-900 px-4 py-1.5 rounded-lg bg-white border border-slate-200 shadow-sm"
                            >
                                Close
                            </button>
                        </div>
