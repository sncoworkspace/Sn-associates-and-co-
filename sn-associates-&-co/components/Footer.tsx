                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        <Link to="/" className="flex items-center gap-3 mb-6 group">
                            <img src="https://image2url.com/images/1764921906714-ca9522a0-9679-4611-822e-55e3ef363a5a.png" alt="SN Associates" className="h-12 w-auto object-contain bg-white rounded p-1" />
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {['About Us', 'Services', 'Contact', 'News', 'Careers', 'Resources'].map((item) => (
                                <li key={item}>
                                    <Link
